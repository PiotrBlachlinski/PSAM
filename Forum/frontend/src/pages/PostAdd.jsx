...
export default function PostAdd() {
    ...
    const fetchCategories = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.error("Nie udało się pobrać kategorii. Status:", response.status);
        }
      } catch (error) {
  ...
  const handleCancel = () => {
    if (user.role === "USER") {
      ...
      navigate("/modView"); // Redirect to moderator view
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSend.append("content", formData.contents);
    formDataToSend.append("categoryId", formData.categoryId);
    formDataToSend.append("userId", formData.userId); // Dodanie userId
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error("Nie udało się utworzyć wpisu. Status:", response.status);
      }
    } catch (error) {
    ...
    <form onSubmit={handleSubmit}>
      <div className="space-y-12">
        ...
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base/7 font-semibold text-gray-900">Utwórz nowy wpis</h2>
            ...
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                ...
                >
                  ...
                  <option value="1">Polityka</option>
                  <option value="2">Memy</option>
                  <option value="3">Pogoda</option>
                </select>
              </div>
            </div>
