  ...
  const handleDeletePost = async (postId) => {
    try {
      ...
      if (response.ok) {
        ...
        console.error("Nie udało się usunąć postu. Status:", response.status);
      }
    } catch (error) {
              ...
              <div className="p-4">
                ...
                <div className="flex space-x-4 text-sm text-gray-500">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center p-2 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500"
                  >
                    Usuń post
                  </button>
                </div>
